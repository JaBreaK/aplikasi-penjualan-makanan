...
export default function SuhartiLandingPageExtended() {
  ...
  return (
    <main className="bg-white text-[#F0A04B]">
...
>
  ...
  >
    <a 
      href="https://gofood.co.id/bandung/restaurant/ayam-goreng-suharti-cipaganti-c2f9102d-8517-41ed-a246-884b9cf5613c" // <-- GANTI DENGAN LINK GOFOOD ASLI
      target="_blank" 
      rel="noopener noreferrer"
      className="bg-[#F0A04B] text-brand-dark font-bold py-3 px-8 rounded-full text-lg hover:bg-yellow-400 transition-transform hover:scale-105 inline-block"
    >
      Pesan via GoFood
    </a>
    <Link 
      href="/menu" 
      className="bg-white/20 backdrop-blur-sm border border-white/50 text-white font-bold py-3 px-8 rounded-full text-lg hover:bg-white/30 transition-transform hover:scale-105 inline-block"
    >
      Pesan di Sini
    </Link>
      ...
      <section className="py-24 px-5">
        <div className="container mx-auto text-center">
          ...
          <Link href="/menu" className="mt-12 inline-block bg-[#F0A04B] text-white font-bold py-3 px-8 rounded-lg hover:bg-black transition-colors text-lg">
      ...
      <section className="py-24 px-5 bg-white">
        <div className="container mx-auto text-center">
            ...
            <motion.div variants={fadeIn()} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} className="max-w-full mx-auto rounded-lg shadow-2xl overflow-hidden">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.052432623904!2d107.60114700000001!3d-6.884323!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e6f453cfc7c3%3A0xd755c1e1973cc075!2sAyam%20Goreng%20Suharti!5e0!3m2!1sid!2smm!4v1756654194895!5m2!1sid!2smm" width="100%" height="400" style={{ border: 0 }} allowFullScreen={false} loading="lazy"></iframe>
                </motion.div>
